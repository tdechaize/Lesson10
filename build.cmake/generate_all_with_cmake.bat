...
REM
REM		Cette procédure gère trois paramètres : le répertoire de l'application à générer, le nom de l'application (qui devient le nom de l'exécutable), et un paramètre optionnel,
REM     l'id de la génération, qui fait partie de la liste suivante (cela permet de sélectionner la cible de génération) :
REM    
REM     [BCC|MINGW32OF|MINGW64CB|DEVCPP|CYGWIN32|CYGWIN64|MINGW32WL|MINGW64WL|TDM32|TDM64|MSYS2W32|MSYS2W64|NMAKEX32|NMAKEX64|VS2022X32|VS2022X64|INTELX32|INTELX64|CLANGX32|CLANGX64|CLANGW32|CLANGW64|CLANGMW32|CLANGMW64|DMC|LCC32|LCC64|PELLESC32|PELLESC64|WATCOM32|WATCOM64] 
REM
