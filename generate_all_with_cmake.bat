...
REM
REM		Cette procédure gère trois paramètres : le répertoire de l'application à générer, le nom de l'application (qui devient le nom de l'exécutable), et un paramètre l'id de la génération,
...
REM		Et, toujours avec cet IDE, l'utilitaire CMAKE génère systèmatiquemet dans la solution Visual Studio, quatre cibles de génération :
...
REM          CLANG_VERSION     valué (à date) par       19.1.6    		(dernière version sur Windows 11, aussi bien pour les binaires valables pour VS2022 que pour les environnements Winlibs)
...
REM     Et pour les quatre compilateurs, non supportés par CMAKE (DMC, LCC, PellesC et Open WATCOM : pas de générateur fourni), j'utilise un simple Makefile. 
...
REM 	Date dernière modification : 	11 juin 2024 : Adjonctions des générations CMAKE avec le compilateur One API INTEL C/C++ adossé à Visual Studio 2022 (32 et 64 bits)
...
REM             Génération cmake pour GCC 13.1.0 intégré à l'environnement IDE Code::Blocks version 23.06
:MINGW64CB
...
REM             Génération cmake pour GCC 12.4.0 intégré à l'environnement CYGWIN 64 bits
:CYGWINN64
...
REM             Génération cmake pour GCC 12.4.0 intégré à l'environnement MinGW32 de CYGWIN64
:CYGWIN32
SET PATH=C:\Program Files\CMake\bin;C:\cygwin64\bin;%PATH%
...
REM             Génération cmake pour GCC 12.4.0 intégré à l'environnement MinGW64 de CYGWIN64
:CYGWIN64
SET PATH=C:\Program Files\CMake\bin;C:\cygwin64\bin;%PATH%
...
REM             Génération cmake pour GCC 14.1.0 UCRT intégré à l'environnement WINLIBS 32 bits
:MINGW32WL
...
REM             Génération cmake pour GCC 14.1.0 UCRT intégré à l'environnement WINLIBS 64 bits
:MINGW64WL
...
REM             Génération cmake pour GCC 14.1.0 intégré à l'environnement MSYS2 en 32 bits
:MSYS2W32
...
REM             Génération cmake pour GCC 14.1.0 intégré à l'environnement MSYS2 en 64 bits
:MSYS2W64
...
REM             Génération cmake pour GCC 14.1.0 intégré à l'environnement MSYS2 UCRT en 64 bits
:MSYS2U64
...
REM             Génération cmake pour OneAPI Intel Compiler en version 32 bits adossé à Visual Studio 2022 
:INTELX32 
...
REM             Génération cmake pour OneAPI Intel Compiler en version 64 bits adossé à Visual Studio 2022 
:INTELX64 
