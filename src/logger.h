...
* \version         2.0.1.0
* \date            5 mars 2023
* \brief           Header de l'ajout de fonction de "logging" (traces dans un fichier texte log.txt) uniquement en mode Debug et avec des niveaux de tracing définis dans une varaiable d'environnement (LEVEL)
